...
cd $TMP_DIR/$VERSION
cp -rf /mnt/user/appdata/unraid-nvidia-vgpu-driver/source/usr $TMP_DIR/$VERSION/
...
chmod -R 755 $TMP_DIR/*
cp -rf $TMP_DIR/$PLUGIN_NAME-$VERSION.txz* /mnt/user/appdata/unraid-nvidia-vgpu-driver/packages/
#rm -R $TMP_DIR